...
public class BookControllerIntegreTest {
	...
	/*
	 * @Test public void delete_테스트() throws Exception { // given Long id = 1L;
	 * 
	 * //when ResultActions resultAction = mockMvc.perform(delete("/book/{id}", id)
	 * .accept(MediaType.TEXT_PLAIN));
	 * 
	 * //then resultAction .andExpect(status().isOk())
	 * .andDo(MockMvcResultHandlers.print());
	 * 
	 * MvcResult requestResult = resultAction.andReturn(); String result =
